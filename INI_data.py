...
new_doc1 = Articles.createDocument(data1)
new_doc2 = Articles.createDocument(data2)
new_doc3 = Articles.createDocument(data3)
new_doc4 = Articles.createDocument(data4)
new_doc1.save()
new_doc2.save()
new_doc3.save()
new_doc4.save()
